                  ...
                  Container(
                    ...
                    child: const MarkdownBody(
                      data: '''
                          ...
                          Außerdem gibt der/die Nutzer:in bei der Registrierung die Identifikationsdaten, die für die Anmeldung im Universitätsnetzwerk notwendig sind, an. E-Mail Adresse und Passwort der Nutzenden werden verwendet, um die Legitimität der Identifikationsdaten durch Anmeldung im Universitätsnetzwerk zu überprüfen. Nach erfolgreicher Anmeldung werden die Daten besuchte Bildungseinrichtung, Fachbereich, Studiengang, Fachsemester, Sprache und E-Mail Adresse der Nutzenden mit einer eindeutigen User-ID verknüpft und gespeichert. Das Passwort der Nutzenden wird von einem  ISO 27018 (https://firebase.google.com/downloads/gdpr/2019_Firebase_ISO_27018.pdf)  geprüftem Dienst verschlüsselt und ist für uns uneinsehbar.
                          Auf dem Endgerät der Nutzenden werden weiterhin bei der Registrierung E-Mail Adresse und Passwort lokal gespeichert, die nicht an uns übermittelt werden. 
                          In der App gibt es ein Bewertungssystem für die Mensagerichte. Es werden die positiven und negativen Bewertungen von Gerichten der Nutzenden gespeichert und mit ihrer/seiner eindeutigen User-ID verknüpft. Die positiven und negativen Bewertungen aller Nutzer:innen werden zusammengerechnet und als eine nicht zurückverfolgbare Zahl und für jede:n Nutzer:in sichtbar in der App dargestellt.
                          ...
                          Die Identifikationsdaten der Nutzenden dienen uns, um plattformübergreifenden, individuellen Service anzubieten und von verschiedenen Endgeräten auf die in der App zur Verfügung gestellten Informationen zuzugreifen.
                          ...
                          ### 1. Beschreibung und Umfang der Datenverarbeitung
                          Einmalig nach der Registrierung und Login in der App und danach nur auf manuelle Anfrage der Nutzenden werden mithilfe der lokal gespeicherten Identifikationsdaten folgende im Universitätsnetzwerk hinterlegte personenbezogenen Daten an uns übermittelt und mit der Identifikationsnummer der Nutzenden verknüpft:
                          (1) Studienfächer   
                          (2) Creditpoints
                          ...
                          ### 1. Beschreibung und Umfang der Datenverarbeitung
                          Es ist eine Kontaktaufnahme über die in unserer App bereitgestellte E-Mail-Adresse möglich. In diesem Fall werden die mit der E-Mail übermittelten personenbezogenen Daten der Nutzenden gespeichert.
                          ...
                          (1)  Löschungspflicht.
                          Du kannst von den Verantwortlichen verlangen, dass die dich betreffenden personenbezogenen Daten unverzüglich gelöscht werden, und der Verantwortliche ist verpflichtet, diese Daten unverzüglich zu löschen, sofern einer der folgenden Gründe zutrifft:
