...
Beim ersten Start der App wird, nach der Auswahl der Bildungseinrichtung, ein anonymer Nutzer:innen Account angelegt in dem die zuvor ausgewählte Bildungseinrichtung gespeichert wird. Dieser Account ist mit einer eindeutigen ID verknüpft.

Bei der optionalen Registrierung in der App werden von Nutzer:innen über Auswahlfelder personenbezogene Daten an uns übermittelt. Diese Daten beinhalten Fachbereich, Studiengang und Fachsemester. Diese Daten werden zu dem vorher angelegten anonymen Account hinzugefügt.

Außerdem gibt der:die Nutzer:in bei der Registrierung die Identifikationsdaten, die für die Anmeldung im Universitätsnetzwerk notwendig sind, an. E-Mail Adresse und Passwort der Nutzer:innen werden verwendet, um die Legitimität der Identifikationsdaten durch Anmeldung im Universitätsnetzwerk zu überprüfen. Nach erfolgreicher Registrierung werden die Daten besuchte Bildungseinrichtung, Fachbereich, Studiengang, Fachsemester, Sprache und E-Mail Adresse der Nutzer:innen mit der erwähnten ID verknüpft und gespeichert. Das Passwort der Nutzer:innen wird von einem ISO 27018 (https://firebase.google.com/downloads/gdpr/2019_Firebase_ISO_27018.pdf) geprüftem Dienst verschlüsselt und ist für uns uneinsehbar.
...
In der App gibt es ein Bewertungssystem für die Mensagerichte. Es werden die positiven und negativen Bewertungen von Gerichten der Nutzer:innen gespeichert und mit der erwähnten eindeutigen ID verknüpft. Die positiven und negativen Bewertungen aller Nutzer:innen werden zusammengerechnet und als eine nicht zurückverfolgbare Zahl und für alle Nutzer:innen sichtbar in der App dargestellt.
...
Nur auf manuelle Anfrage der Nutzer:innen werden mithilfe der lokal gespeicherten Identifikationsdaten folgende im Universitätsnetzwerk hinterlegte personenbezogenen Daten an uns übermittelt und mit der Identifikationsnummer der Nutzer:innen verknüpft:
...
Der:die Nutzer:in hat jederzeit die Möglichkeit, seine:ihre Einwilligung zur Verarbeitung der Identifikationsdaten zu widerrufen. Der Widerruf der Einwilligungserklärung erfolgt durch Mitteilung an die Verantwortlichen per E-Mail.
...
Die Übermittlung von Daten durch Firebase an Google verfolgt den Zweck, durch die gesammelten Daten die Nutzung der App auszuwerten, wodurch wir unser Angebot verbessern und für dich als Nutzer:in optimieren können.
